...
<html lang="en">
    ...
    <body>
            ...
            <header>
                <img src="resources/img/babymasculin.jpg" alt="u13 poza grup">
            </header>
            ...
            <div class="dropdown">
                ...
                <div id="myDropdown" class="dropdown-content">
                    ...
                    <?php
                        ...
                        $sql="SELECT `id`,`nume`,`prenume` FROM jucatori WHERE echipa='5' AND poza!='#'";
                    ...
                    <?php
                        ...
                        $sql="SELECT `nume`,`prenume` FROM antrenori,echipe WHERE antrenori.id=echipe.`antrenor principal` AND echipe.id=5";
                        ...
                        $sql="SELECT `nume`,`prenume` FROM antrenori,echipe WHERE antrenori.id=echipe.`antrenor secund` AND echipe.id=5";
            ...
            <?php
                ...
                $sql="SELECT * FROM jucatori WHERE echipa='5' AND poza!='#'";
        ...
        <!-- <section class="coach">
            ...
            <section class="coach" id="a1">
                <div class="player-content">    
                    <?php
                        $sql="SELECT `nume`,`prenume`,`poza`,`data_nasterii`,`locul_nasterii`,`cetatenie`,`facebook`,`instagram` FROM antrenori,echipe WHERE antrenori.id=echipe.`antrenor principal` AND echipe.id=5";
            ...
            <section class="coach" id="a2">
                <div class="player-content">    
                    <?php
                        $sql="SELECT `nume`,`prenume`,`poza`,`data_nasterii`,`locul_nasterii`,`cetatenie`,`facebook`,`instagram` FROM antrenori,echipe WHERE antrenori.id=echipe.`antrenor secund` AND echipe.id=5";
